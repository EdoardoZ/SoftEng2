...
\begin{enumerate}[NUM]
    ...
    In \code{SetCalendar.java} sometimes the \code{==} operator is used: lines 168, 185, 188, 194, 197.
    %In teoria va bene se usato con null, no? NE PARLIAMO DOPO GIANLU   non ero sicuro neanch'io  
...
\begin{enumerate}[NUM]
    ...
    In \code{SetCalendar.java} some errors are displayed, while others are throws from method: lines 105, 152, 326.% ha senso?
...
\begin{enumerate}[NUM]
    ...
    \item In \code{UrlServletHelper.java} an example of "brutish programming" can be found from line 105 to 119, from 122 to 151 and from 205 to 282.\\
    In \code{SetCalendar.java} no example of "brutish programming" can be found. %credo
